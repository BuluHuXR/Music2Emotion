...
class Predict(object):
    ...
    def get_test_score(self):
        ...
        for line in tqdm.tqdm(self.test_list):
            ...
            print("self.file_dict[fn]['tags'][0]", self.file_dict[fn]['tags'][0])

            if str(self.file_dict[fn]['tags'][0].split("-")[-1][:3]) == str(predicted_labels.split("-")[-1][:3]):
                nomo_count = nomo_count + 1
            total_count += 1
            print(f"Result:{nomo_count:>3}/{total_count:<3}")
            accuracy = nomo_count / total_count
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_load_path', type=str, default='./../models/MER31K/short_mer31k_nomo/best_model.pth')
